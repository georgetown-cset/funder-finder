...
def get_funding_stats(project_slug: str) -> dict:
    ...
    result = requests.post(f"https://api.opencollective.com/graphql/v2/{api_key}",
...
if __name__ == "__main__":
    assert os.environ.get(API_KEY), "Please `export OPENCOLLECTIVE_API_KEY=<your opencollective api key>"
